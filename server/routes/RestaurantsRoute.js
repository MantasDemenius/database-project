...
module.exports = (app, conn) => {
  ...
  app.post('/List/Restaurants/del', (req, res) => {
    let id = req.query.id;
  ...
  app.post('/List/Restaurants/edit', (req, res) => {
  ...
  app.post('/List/Restaurants/add', (req, res) => {
  ...
  app.get('/List/Restaurants/suppliers', (req, res) => {
    var sql = "SELECT \
